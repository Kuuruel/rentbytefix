...
class RentalController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // Cek properti milik tenant yang sedang login
            ...
            $renter = Renter::updateOrCreate(
                ...
                [
                    ...
                    'tenant_id' => $currentTenant->id, // Menggunakan ID tenant yang login
    ...
    /**
     * Get properties owned by current tenant
     */
    ...
    /**
     * Get rental statistics for current tenant
     */
