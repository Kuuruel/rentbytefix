    ...
    <div class="grid grid-cols-1 gap-6 mb-6">
        <div class="col-span-1">
            <div
                ...
                <!-- Button Manage di pojok kanan atas -->
                <div class="absolute top-4 left-4 sm:top-6 sm:left-6 z-10">
                    <button
                        class="px-4 py-2 text-sm font-medium text-blue-600 bg-neutral-100 dark:bg-neutral-600 dark:text-blue-400 rounded-lg hover:bg-neutral-200 dark:hover:bg-neutral-500 transition-colors">
                        Manage
                    </button>
                </div>
                ...
                <div class="p-4 sm:p-6 pr-20 sm:pr-24">
                    <div class="flex flex-col sm:flex-row items-center sm:items-start gap-4">
                        <!-- Profile Image -->
                        <div class="flex-shrink-0">
                            <img src="{{ asset('assets/images/user-grid/user-grid-img14.png') }}" alt="Jane Doe"
                                class="w-16 h-16 sm:w-20 sm:h-20 rounded-full object-cover">
                        </div>

                        <!-- User Info -->
                        <div class="flex flex-col text-center sm:text-left">
                            <h3 class="text-lg sm:text-xl font-semibold text-neutral-800 dark:text-white mb-1">Jane Doe</h3>
                            <span class="text-sm sm:text-base text-neutral-500 dark:text-neutral-400">Administrator</span>
                        </div>
                    </div>
                </div>
    ...
    <div class="grid grid-cols-1 3xl:grid-cols-12 gap-6">
        <div class="col-span-12 3xl:col-span-9">
            <div class="grid grid-cols-1 sm:grid-cols-12 gap-6">
                <div class="col-span-12 sm:col-span-6 xl:col-span-4 2xl:col-span-3">
                    <div
                        ...
                        <div class="card-body p-0">
                            ...
                            <p class="text-sm mb-0 text-gray-600"><span class="text-cyan-600 dark:text-cyan-600">4</span>
                ...
                <div class="col-span-12 sm:col-span-6 xl:col-span-4 2xl:col-span-3">
                    <div
                        class="card border-0 p-4 shadow-[0_0.25rem_1.875rem_rgba(46,45,116,0.05)] rounded-lg h-full bg-gradient-to-l from-lilac-600/10 to-bg-white">
                        <div class="card-body p-0">
                            <div class="flex flex-wrap items-center justify-between gap-1 mb-2">
                                <div class="flex items-center gap-2">
                                    <span
                                        class="w-12 h-12 bg-lilac-600/25 text-lilac-600 dark:text-lilac-600 flex-shrink-0 flex justify-center items-center rounded-full h6 mb-0">
                            ...
                            <p class="text-sm mb-0 text-gray-600"><span class="text-lilac-600 dark:text-lilac-600">8</span>
                                Staffs on vacation</p>
                        </div>
                    </div>
                </div>
                <div class="col-span-12 sm:col-span-6 xl:col-span-4 2xl:col-span-3">
                    <div
                        ...
                        <div class="card-body p-0">
                            ...
                            <p class="text-sm mb-0 text-gray-600"><span
                                    class="text-primary-600 dark:text-primary-600">170</span> New patients admitted</p>
                        </div>
                    </div>
                </div>
                <div class="col-span-12 sm:col-span-6 xl:col-span-4 2xl:col-span-3">
                    <div
                        ...
                        <div class="card-body p-0">
                            ...
                            <p class="text-sm mb-0 text-gray-600"><span
                                    class="text-success-600 dark:text-success-600">60,000 </span> Medicine on reserve</p>
                        </div>
                    </div>
                </div>
                            ...
                            <ul class="flex flex-col gap-3">
                                <li>
                                    <span class="text-lg">Cardiology: <span
                                            class="text-primary-600 dark:text-primary-600 font-semibold">80%</span> </span>
                                </li>
                                <li>
                                    <span class="text-lg">Psychiatry: <span
                                            class="text-warning-600 dark:text-warning-600 font-semibold">40%</span> </span>
                                </li>
                                <li>
                                    <span class="text-lg">Pediatrics: <span
                                            class="text-success-600 dark:text-success-600 font-semibold">10%</span> </span>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="flex flex-col gap-6">
                                <div class="flex items-center justify-between gap-3">
                                    <div class="flex items-center">
                                        <img src="{{ asset('assets/images/home-eight/doctor-img1.png') }}" alt=""
                                    ...
                                    <span
                                        class="bg-success-focus text-success-main dark:text-success-main px-2.5 py-1 rounded-lg font-medium text-sm">Available</span>
                                </div>
                                <div class="flex items-center justify-between gap-3">
                                    <div class="flex items-center">
                                        <img src="{{ asset('assets/images/home-eight/doctor-img2.png') }}" alt=""
                                            class="w-10 h-10 rounded-full flex-shrink-0 me-3 overflow-hidden">
                                        <div class="flex-grow-1">
                                ...
                                <div class="flex items-center justify-between gap-3">
                                    <div class="flex items-center">
                                        <img src="{{ asset('assets/images/home-eight/doctor-img3.png') }}" alt=""
                                            class="w-10 h-10 rounded-full flex-shrink-0 me-3 overflow-hidden">
                                        <div class="flex-grow-1">
                                    ...
                                    <span
                                        class="bg-danger-focus text-danger-main dark:text-danger-main px-2.5 py-1 rounded-lg font-medium text-sm">Not
                                        Available</span>
                                </div>
                                <div class="flex items-center justify-between gap-3">
                                    <div class="flex items-center">
                                        <img src="{{ asset('assets/images/home-eight/doctor-img4.png') }}" alt=""
                                            class="w-10 h-10 rounded-full flex-shrink-0 me-3 overflow-hidden">
                                        <div class="flex-grow-1">
                                ...
                                <div class="flex items-center justify-between gap-3">
                                    <div class="flex items-center">
                                        <img src="{{ asset('assets/images/home-eight/doctor-img6.png') }}" alt=""
                                            class="w-10 h-10 rounded-full flex-shrink-0 me-3 overflow-hidden">
                                        <div class="flex-grow-1">
                                ...
                                <div class="flex items-center justify-between gap-3">
                                    <div class="flex items-center">
                                        <img src="{{ asset('assets/images/home-eight/doctor-img5.png') }}" alt=""
                                            class="w-10 h-10 rounded-full flex-shrink-0 me-3 overflow-hidden">
                                        <div class="flex-grow-1">
                                ...
                                <table class="table bordered-table mb-0 rounded-0 border-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>27 Mar 2025</td>
                                            <td><span
                                                    class="bg-success-focus text-success-main dark:text-success-main px-2.5 py-1 rounded-lg font-medium text-sm">Completed</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>2h 5m 40s</td>
                                            <td><span
                                                    class="bg-danger-focus text-danger-main dark:text-danger-main px-2.5 py-1 rounded-lg font-medium text-sm">Canceled</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Heart Checkup</td>
                        ...
                        <div class="card-body p-1.5">
                            <div class="relative">
                                <div id="statisticsDonutChart"
                                    class="mt-9 flex-grow-1 apexcharts-tooltip-z-none title-style circle-none"></div>
                        ...
                        <div class="card-body">
                            <div class="flex items-center justify-between gap-3 mb-6">
                                <div class="flex items-center gap-3">
                                    <div
                                        class="w-10 h-10 rounded-full flex-shrink-0 bg-info-600/10 flex justify-center items-center">
                                        <img src="{{ asset('assets/images/home-eight/treatment-icon1.png') }}"
                                            alt="" class="">
                                    </div>
                                    <div class="flex-grow-1">
                            ...
                            <div class="flex items-center justify-between gap-3 mb-6">
                                <div class="flex items-center gap-3">
                                    <div
                                        class="w-10 h-10 rounded-full flex-shrink-0 bg-success-600/10 flex justify-center items-center">
                                        <img src="{{ asset('assets/images/home-eight/treatment-icon2.png') }}"
                                            alt="" class="">
                                    </div>
                                    <div class="flex-grow-1">
                            ...
                            <div class="flex items-center justify-between gap-3 mb-6">
                                <div class="flex items-center gap-3">
                                    <div
                                        class="w-10 h-10 rounded-full flex-shrink-0 bg-lilac-600/10 flex justify-center items-center">
                                        <img src="{{ asset('assets/images/home-eight/treatment-icon3.png') }}"
                                            alt="" class="">
                                    </div>
                                    <div class="flex-grow-1">
                            ...
                            <div class="flex items-center justify-between gap-3 mb-6">
                                <div class="flex items-center gap-3">
                                    <div
                                        class="w-10 h-10 rounded-full flex-shrink-0 bg-warning-600/10 flex justify-center items-center">
                                        <img src="{{ asset('assets/images/home-eight/treatment-icon4.png') }}"
                                            alt="" class="">
                                    </div>
                                    <div class="flex-grow-1">
                            ...
                            <div class="flex items-center justify-between gap-3 mb-6">
                                <div class="flex items-center gap-3">
                                    <div
                                        class="w-10 h-10 rounded-full flex-shrink-0 bg-danger-600/10 flex justify-center items-center">
                                        <img src="{{ asset('assets/images/home-eight/treatment-icon5.png') }}"
                                            alt="" class="">
                                    </div>
                                    <div class="flex-grow-1">
                            ...
                            <div class="flex items-center justify-between gap-3 mb-0">
                                <div class="flex items-center gap-3">
                                    <div
                                        class="w-10 h-10 rounded-full flex-shrink-0 bg-primary-600/10 flex justify-center items-center">
                                        <img src="{{ asset('assets/images/home-eight/treatment-icon6.png') }}"
                                            alt="" class="">
                                    </div>
                                    <div class="flex-grow-1">
                        ...
                        <div class="card-body">
                            <div class="flex flex-col gap-4">
                                <div class="flex items-center justify-between gap-3">
                                    <div class="flex items-center gap-3">
                                        <div class="flex-shrink-0">
                                            <img src="{{ asset('assets/images/home-eight/icon-pdf.png') }}"
                                                alt="" class="">
                                        </div>
                                        <div class="flex-grow-1">
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <button type="button"
                                            class="w-8 h-8 d-inline-flex justify-center items-center bg-success-600/10 hover:bg-success-600 active:scale-75 hover:text-white duration-300 text-success-600 bg-hover-success-600 text-hover-white text-base rounded-full">
                                ...
                                <div class="flex items-center justify-between gap-3">
                                    <div class="flex items-center gap-3">
                                        <div class="flex-shrink-0">
                                            <img src="{{ asset('assets/images/home-eight/icon-text.png') }}"
                                                alt="" class="">
                                        </div>
                                        <div class="flex-grow-1">
