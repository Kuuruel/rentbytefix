                ...
                <div class="card-body p-5">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            {{-- 🔥 TAMBAH: Fee Structure Info --}}
                            <div class="mt-2">
                                <span
                                    class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-success-100 text-success-800 dark:bg-success-900 dark:text-success-200">
                    ...
                    {{-- 🎯 TAMBAH: Revenue Breakdown (Hanya tampil jika ada data debug) --}}
