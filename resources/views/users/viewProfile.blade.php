                    ...
                    <div class="relative h-full bg-white dark:bg-gray-800 rounded-3xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden transform transition-all duration-500 hover:scale-105">
                        ...
                        <div class="relative p-8 pt-8">
                            <div class="text-center">
                                ...
                                <div class="inline-flex items-center px-6 py-3 rounded-full text-sm font-semibold bg-gradient-to-r from-blue-500 to-purple-600 text-black dark:text-white shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                                    <svg class="w-4 h-4 mx-2 text-black dark:text-white" fill="currentColor" viewBox="0 0 20 20">
                                            ...
                                            <div id="password-button-container" class="flex justify-center mt-6 mb-6">
                                                <button type="button" id="enable-password-edit" 
                                                    ...
                                                    <span class="relative flex items-center">
                                                        <svg class="w-5 h-5 mx-2 text-black dark:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path>
                                                        </svg>
                                                        Change Password
                                                    </span>
