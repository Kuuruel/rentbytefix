            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 ">
                ...
                <div class="col-span-12 lg:col-span-4">
                    <div class="relative group h-full">
                        <div
                            class="absolute inset-0  rounded-lg blur opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 animate-tilt">
                        </div>
                        <div
                            class="relative h-full bg-white dark:bg-gray-800 rounded-lg shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden transform transition-all duration-500 hover:scale-105">
                            ...
                            <div class="relative p-8 pt-8">
                                <div class="text-center">
                                    ...
                                    <div class="relative inline-block mb-6 p-6">
                                        <div
                                            class="absolute inset-0  rounded-lg blur-md opacity-50 animate-pulse">
                                        </div>
                                        <div id="profileCardAvatar"
                                            ...
                                            @if ($user->img)
                                                <img src="{{ asset('assets/images/super-admin/' . $user->img) }}"
                                                    ...
                                                    data-fallback-img>
                                                <div
                                                    class="w-full h-full  flex items-center justify-center rounded-full hidden">
                                                    <span
                                    ...
                                    <h2
                                        class="text-2xl font-bold mb-3 text-gray-800 dark:text-white tracking-tight  bg-clip-text text-transparent">
                                        {{ $user->name }}</h2>
                                    <p
                                    ...
                                    <div
                                        class="inline-flex items-center px-6 py-3 rounded-full text-sm font-semibold \ text-black dark:text-white shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                ...
                <div class="col-span-12 lg:col-span-8">
                    <div class="relative group ">
                        <div
                            class="absolute inset-0  rounded-3xl blur opacity-20 group-hover:opacity-30 transition duration-500">
                        </div>
                        <div
                            class="relative bg-white dark:bg-gray-800 rounded-lg shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden px-4">
