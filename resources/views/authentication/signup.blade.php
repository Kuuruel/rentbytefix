        ...
        <div class="lg:w-1/2 py-8 px-6 flex flex-col justify-center">
            <div class="lg:max-w-[464px] mx-auto w-full">
                ...
                <form action="{{ route('register') }}" method="POST">
                    ...
                    <div class="mb-4">
                        <select name="role"
                            class="form-control h-[56px] border-neutral-300 bg-neutral-50 dark:bg-dark-2 rounded-xl w-full"
                            required>
                    ...
                    <div class="mb-5">
                        ...
                        <span class="mt-3 text-sm text-secondary-light">Your password must have at least 6
                            characters</span>
                    </div>
                    <div class="mt-6">
